            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="mastersi.php">Master SI</a>
                         <a class="collapse-item" href="masterserver.php">Master Server</a>
                          <a class="collapse-item" href="masterskala.php">Master Skala</a>
                    </div>
                </div>
            </li>
         ...
         <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Kasman faqot</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
